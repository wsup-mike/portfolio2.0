...
function ContactMe({}: Props) {
  ...
  return (
    <div className='h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center '>
        <h3 className='absolute top-24 uppercase text-gray-500 tracking-[20px] text-center text-lg px-5'>Contact Me</h3>
  
        <div className='flex flex-col space-y-10 mt-56 border border-yellow-300 w-full p-6'>
