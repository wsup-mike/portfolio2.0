...
function BackgroundCircles({}: Props) {
  return (
    <div className='relative flex justify-center items-center'>
        ...
        <div className='absolute border border-blue-500 w-[650px] h-[650px] rounded-full mt-52 animate-pulse' />
        <div className='absolute border border-blue-500 w-[800px] h-[800px] rounded-full mt-52 animate-pulse' />
